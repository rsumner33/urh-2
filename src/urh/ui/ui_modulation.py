...
# Form implementation generated from reading ui file '../ui/modulation.ui'
#
...
class Ui_DialogModulation(object):
    def setupUi(self, DialogModulation):
        ...
        self.horizontalLayout.addWidget(self.linEdDataBits)
        self.btnRestoreBits = QtWidgets.QToolButton(self.scrollAreaWidgetContents_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.btnRestoreBits.setIcon(icon)
        self.btnRestoreBits.setObjectName("btnRestoreBits")
        self.horizontalLayout.addWidget(self.btnRestoreBits)
        ...
        DialogModulation.setTabOrder(self.btnAutoDetect, self.spinBoxBitLength)
